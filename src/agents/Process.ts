...
import ProductionRobot, { ManifactureResult, ProductionRobotReply, ProductionRobotReserveResult, ReservedStatus, ReservedStatusQuery, StartManufactureQuery } from "./ProductionRobot";
import ProcessInput from "../data/process/ProcessInput";
import { chooseClosest , Dist } from "../interfaces/ILocatable";
import LogisticRobot, { LogisticRobotBusyReply, LogisticRobotMoveQuery, LogisticRobotMoveResult, LogisticRobotReserveQuery, LogisticRobotReserveReply } from "./LogisticRobot";
...
import Holder, { HolderAnnoucementReply, HolderReserveQuery, HolderReserveResponse, HolderUnreserveQuery } from "./Holder";
